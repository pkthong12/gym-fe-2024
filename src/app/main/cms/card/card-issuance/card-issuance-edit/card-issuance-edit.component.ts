...
export class CardIssuanceEditComponent extends BaseEditComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  formLabel = {
      ...
      documentNumberPlaceholder: !this.language ? 'Số chứng từ sẽ được tự động sinh ' : 'Document Number will be spontaneously arising',
      ...
      hourCardBonusrCard: !this.language ? 'Số giờ tặng thêm' : 'Number of bonus exercise hours',
